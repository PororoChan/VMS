            ...
            <div class="card full-height">
                <div class="card-header">
                    <div class="card-body float-right text-right text-fixed">
                        <button type="button" class="btn btn-lg btn-primary" style="margin-left: 800px;" id="buttonTambah" onclick="modalGlobal('Add Alias', 'modal-lg', '<?= base_url('alias/AddViews') ?>')">Add</button>
                    </div>
                </div>
                <style>
